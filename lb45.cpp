// accept 5 numbers from user and display count of total even numbers
#include<iostream>
using namespace std;
...
int main()
{
	...
	iEvencnt = aobj.CheckEven(iSize);	
	cout<<"Total number of even elements from array is "<<iEvencnt<<endl;
